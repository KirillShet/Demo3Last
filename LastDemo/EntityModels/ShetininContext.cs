...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=45.67.56.214;Username=shetinin;Password=HrYyCFZ8;Port=5454;Database=shetinin");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Client>(entity =>
        {
            ...
            entity.ToTable("client", "LastDemo");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Clients)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("tagofclient", "LastDemo");
        ...
        modelBuilder.Entity<Clientservice>(entity =>
        {
            ...
            entity.ToTable("clientservice", "LastDemo");
        ...
        modelBuilder.Entity<Documentbyservice>(entity =>
        {
            ...
            entity.ToTable("documentbyservice", "LastDemo");
        ...
        modelBuilder.Entity<Gender>(entity =>
        {
            ...
            entity.ToTable("gender", "LastDemo");
        ...
        modelBuilder.Entity<Manufacturer>(entity =>
        {
            ...
            entity.ToTable("manufacturer", "LastDemo");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.ToTable("product", "LastDemo");
            ...
            entity.HasMany(d => d.Attachedproducts).WithMany(p => p.Mainproducts)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("attachedproduct", "LastDemo");
        ...
        modelBuilder.Entity<Productphoto>(entity =>
        {
            ...
            entity.ToTable("productphoto", "LastDemo");
        ...
        modelBuilder.Entity<Productsale>(entity =>
        {
            ...
            entity.ToTable("productsale", "LastDemo");
        ...
        modelBuilder.Entity<Service>(entity =>
        {
            ...
            entity.ToTable("service", "LastDemo");
        ...
        modelBuilder.Entity<Servicephoto>(entity =>
        {
            ...
            entity.ToTable("servicephoto", "LastDemo");
